...
CREATE TABLE IF NOT EXISTS MagnumBLMLeases.details(
...
CREATE TABLE IF NOT EXISTS MagnumBLMLeases.sale_info(
...
CREATE TABLE IF NOT EXISTS MagnumBLMLeases.investment(
LEASE_NO VARCHAR(15) UNIQUE,
YEARS_RENEWED INT,
RENTALS_PAID FLOAT,
...
CREATE TABLE IF NOT EXISTS MagnumBLMLeases.interest(
LEASE_NO VARCHAR(15) UNIQUE,
UA float,
RA float,
KA float,
...
CREATE TABLE IF NOT EXISTS MagnumBLMLeases.recording(
LEASE_NO VARCHAR(15) UNIQUE,
